...
func registerRoutes(router *gin.Engine, db *gorm.DB) {
	...
	router.PATCH("/api/region/:id", regionHandler.UpdateRegion)
	...
	router.PATCH("/api/package/:id", packageHandler.UpdatePackage)
	...
	router.PATCH("/api/vehicle/:id", vehicleHandler.UpdateVehicle)
	...
	router.PATCH("/api/trip-log/:id", tripLogHandler.UpdateTripLog)
	...
	router.PATCH("/api/delivery-log/:id", deliveryLogHandler.UpdateDeliveryLog)
	...
	router.PATCH("/api/employee/:id", middleware.AuthRequired("관리직"), employeeHandler.UpdateEmployee)
	...
	router.PATCH("/api/emergency-log/:id", emergencyLogHandler.UpdateEmergencyLog)
