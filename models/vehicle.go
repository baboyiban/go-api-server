...
type Vehicle struct {
	...
	VehicleID         string `json:"vehicle_id" gorm:"column:vehicle_id;type:varchar(15);uniqueIndex:uq_vehicle_id;not null"`
	...
	AICoordX          *int   `json:"AI_coord_x" gorm:"column:AI_coord_x;type:int"`
	AICoordY          *int   `json:"AI_coord_y" gorm:"column:AI_coord_y;type:int"`
}
